...
public:
    ...
    Q_PROPERTY(bool            partcurrwarning          READ partcurrwarning                  NOTIFY partcurrwarn)
    Q_PROPERTY(bool            lightstatus         READ lightstatus                  NOTIFY lightstatusChanged)
    Q_PROPERTY(short            motorstatus          READ motorstatus                  NOTIFY motorstatusChanged)
    ...
    Q_PROPERTY(Fact* pitchRate          READ pitchRate          CONSTANT)
    Q_PROPERTY(Fact* yawRate            READ yawRate            CONSTANT)
    Q_PROPERTY(Fact* partcurr            READ partcurr            CONSTANT)
    ...
    Q_INVOKABLE void mcw();
    Q_INVOKABLE void mccw();
    Q_INVOKABLE void mstop();
    ...
    Fact* pitchRate                         () { return &_pitchRateFact; }
    Fact* yawRate                           () { return &_yawRateFact; }
    Fact* partcurr                           () { return &_partcurrFact; }
    ...
    Q_INVOKABLE bool    _currwaring=0;
    Q_INVOKABLE bool    currwaring();
    bool                _lightstatus=0;
    short                _motorstatus=0;
    ...
    bool        partcurrwarning         ()  { return _currwaring; }
    bool        lightstatus             ()  {return _lightstatus;}
    short       motorstatus             ()  {return _motorstatus;}
...
private:
    ...
    static const char* _pitchRateFactName;
    static const char* _yawRateFactName;
    static const char* _partcurrFactName;
