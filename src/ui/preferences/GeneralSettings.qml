                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        GridLayout {
                            ...
                            QGCLabel {
                                text:                   qsTr("视频来源2")
                                visible:                QGroundControl.settingsManager.videoSettings.videoSource2.visible
                            }
                            FactComboBox {
                                id:                     videoSource2
                                Layout.preferredWidth:  _comboFieldWidth
                            ...
                            QGCLabel {
                                ...
                                visible:                (_isGst || _isGst2) && QGroundControl.settingsManager.videoSettings.disableWhenDisarmed.visible
                            }
                            FactCheckBox {
                                text:                   ""
                            ...
                            QGCLabel {
                                ...
                                visible:                (_isGst || _isGst2) && QGroundControl.settingsManager.videoSettings.lowLatencyMode.visible
                            }
                            FactCheckBox {
                                text:                   ""
                    ...
                    QGCLabel {
                        ...
                        visible:                        (QGroundControl.settingsManager.videoSettings.visible && (_isGst || _isGst2)) || QGroundControl.videoManager.autoStreamConfigured
                    }
                    Rectangle {
